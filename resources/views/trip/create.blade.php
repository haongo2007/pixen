@extends('layouts.mobile',['page' => __('Post Your Trip'), 'pageSlug' => 'package-create'])

@section('content')
    <!-- start content -->
    <div class="container-fluid content trip has-btn-footer">
        @include('alerts.error')
        {!! Form::open(['id' => 'trip_form' ,'method' => 'post']) !!}
            ...
            <div class="row no-gutters">
                <div class="form-group w-100">
                    ...
                    <span class="is-invalid-feedback begin_place" role="alert">
                        <strong></strong>
                    </span>
                </div>
            </div>
            ...
            <div class="row no-gutters">
                <div class="form-group w-100">
                    <label for="begin_time">Departure Date</label>
                    {!! Form::text('begin_time', null, ['id' => 'begin_time', 'required','class' => 'form-control single-date', 'placeholder' => 'Date start', 'autocomplete' => "off", 'readonly']) !!}
                    <span class="separator"></span>
            ...
            <div class="row no-gutters">
                <div class="form-group w-100">
                    ...
                    {!! Form::text('arrival_time', null, ['id' => 'arrival_time', 'required','class' => 'form-control single-date', 'placeholder' => 'Arrival Date', 'autocomplete' => "off", 'readonly']) !!}
                    <span class="separator"></span>
            ...
            <div class="row no-gutters">
                <div class="form-group  w-100">
                    ...
                    {!! Form::number('size', null, ['id' => 'size', 'required','class' => 'form-control', 'placeholder' => 'Empty Luggage', 'autocomplete' => "off"]) !!}
                    <span class="separator"></span>
            ...
            <div class="row no-gutters">
                <div class="col-12">
                    <button class="btn btn-pixen bg-pixen w-100 mt-4 submit" type="button">Post</button>
                </div>
            </div>
        {!! Form::close() !!}
    </div>
